...
To get started using MEIRLOP, see our [quickstart guide](notebooks/quickstart.ipynb), which gives you a quick idea of what data formats go into and out of MEIRLOP so you can use it for your own experiments. For a full usage example, see our [walkthrough](notebooks/walkthrough.ipynb), which recreates commands and output for the section "MEIRLOP identifies enriched TF binding motifs in DNase I Hypersensitive Sites" from the MEIRLOP manuscript.
